    ...
    return (
        <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-gradient-to-b from-gray-800 to-black'>
            <div className='flex flex-row gap-1 relative'>
              <h3 className='text-2xl font-mono ml-4 border-l-4 pl-2 italic text-gray-300 relative z-10'>
    "Make it work, make it right, make it fast.”
</h3>

                <div className="cursor-blink absolute h-full bg-gray-300 w-1 -right-1 animate-blink"></div>
            </div>
